...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-o4p8qym.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-o4p8qym.containers.anotherwebservice.com/
...
```
git clone git@github.com:MrBwoken/container-o4p8qym.git
cd container-o4p8qym
```
...
```
docker attach container-o4p8qym
```
